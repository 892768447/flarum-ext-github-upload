export default class DragAndDrop {
    ...
    in(e) {
        ...
        if (!this.over) {
            this.textarea.toggleClass('irony-github-upload-dragging', true);
            this.over = true;
        }
    }
    ...
    out(e) {
        ...
        if (this.over) {
            this.textarea.toggleClass('irony-github-upload-dragging', false);
            this.over = false;
        }
    }
    ...
    dropping(e) {
        ...
        if (!this.isDropping) {
            ...
            this.textarea.addClass('irony-github-upload-dropping');

            m.redraw();

            this.uploadButton.uploadFiles(e.originalEvent.dataTransfer.files)
                .then(() => {
                    this.textarea.removeClass('irony-github-upload-dropping');
