...
class LoadSettingsFromDatabase
{
    ...
    {
        $event->settings['irony.github.upload.availableUploadMethods'] = $this->settings->getAvailableUploadMethods()->toArray();
    }
    ...
    {
        $event->settings['irony.github.upload.availableTemplates'] = $this->settings->getAvailableTemplates()->toArray();
    }
}
