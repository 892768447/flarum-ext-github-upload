...
namespace Irony\Github\Upload\Templates;
...
class ImagePreviewTemplate extends AbstractTemplate
{
    ...
    {
        return $this->trans('flarum-ext-github-upload.admin.templates.image-preview');
    }
    ...
    {
        return $this->trans('flarum-ext-github-upload.admin.templates.image-preview_description');
    }
