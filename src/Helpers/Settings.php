...
namespace Irony\Github\Upload\Helpers;

use Aws\AwsClient;
use Irony\Github\Upload\Templates\AbstractTemplate;
...
class Settings
{
    ...
    public function getAvailableUploadMethods()
    {
        ...
        return collect($methods)
            ...
            ->map(function ($item) {
                return app('translator')->trans('flarum-ext-github-upload.admin.upload_methods.'.$item);
            });
    }
